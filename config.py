...
BOT_USERNAME = environ.get("BOT_USERNAME", "AtoZ_Filess_Bot") # without @
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "1002273679174"))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://vj-file-store-9y72.onrender.com")
